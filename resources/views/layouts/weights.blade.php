    ...
    <div id="page-container"
        ...
        <main id="main-container">
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-alt" id="dob"
                                           {{--                                           name="dob" value="{{(new DateTime($data['biodata']['dob']))->format('d/m/Y') }}" readonly>--}}
                ...
                <div class="block block-rounded">
                    ...
                    <div class="block-content">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <div class="form-group">
                                    <label for="dob">UACE Points</label>
                                    <input type="text" class="form-control form-control-alt" id="dob"
                                           name="dob" placeholder="Text Input" readonly value="{{$data['points']}}">
                                </div>
                            </div>
                            {{--                            {{print_r($data['results'])}}--}}
                            <div class="col-lg-4 col-xl-4">
                                <div class="form-group">
                                    <label for="dob">UACE Weight</label>
                                    <input type="text" class="form-control form-control-alt" id="dob"
                                           name="dob" placeholder="Text Input" readonly value="{{$data['weight']}}">
                                </div>
                            </div>
            ...
            <!-- Dynamic Table Full -->
                <div class="block block-rounded">
                    <div class="block-header">
                        <h3 class="block-title">programme details</h3>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">RELEVANTS</th>
                                    <th scope="col">DESIRABLES</th>
                                    <th scope="col">Weight</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    <td style="color: #0d6efd; font-weight: bold">  {{$data['course']}}</td>
                                    <td>{{\App\Helpers\Utilities::weightSubjects($data['essentials'])}}</td>
                                    <td>{{\App\Helpers\Utilities::weightSubjects($data['relevants'])}}</td>
                                    <td>{{\App\Helpers\Utilities::weightSubjects($data['desirables'])}}</td>
                                    <td>{{App\Models\Course::where('name', $data['course'])->first()->weight}}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
